...
using Unitful
  ...
  export refractive_index, Ciddor
  using Core.Intrinsics: sqrt_llvm
  using Base: IEEEFloat
  using ScopedValues
  include("refraction_index_models.jl")
...
atol(::Type{Float32}) = ATOL32[]
  ...
  function distance_from_unit_circle(origin::Vec2{T},direction::Vec2{T}) where T
  ...
  function distance_from_segment(A::Vec2{T},B::Vec2{T},C::Vec2{T},D::Vec2{T}) where T
